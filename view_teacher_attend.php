...
$sql = "SELECT * FROM `attendance` WHERE subject_code IN ($subArrstr) ORDER BY id DESC";
        ...
        <div class="col-12">
            <div class="bg-light rounded h-100 p-4">
                ...
                if (isset($_GET['startdate']) && isset($_GET['enddate']) && isset($_GET['subject']) && isset($_GET['batch'])) {
                    ...
                    $sql = "SELECT * FROM attendance WHERE STR_TO_DATE(`date`, '%d-%m-%Y') BETWEEN '$sdateString' AND '$edateString' AND `subject_code`=$subject_code AND `batch`='$batch'";
                    $result = mysqli_query($conn, $sql);
                ?>
